...
function addLayersAttributesV2() {
    try {
		...
		var zoned = getGISInfoArrayByParcel_DELAND(aa.env.getValue("ParcelValidatedNumber"), "Accela/Accela_Basemap", "Zoning District Boundaries", "Zoning_Dis");
        ...
        logDebug("getGisByparcel_deland: " + getGISInfoArrayByParcel_DELAND(aa.env.getValue("ParcelValidatedNumber"), "Accela/Accela_Basemap", "Zoning District Boundaries", "Zoning_Dis"));
        if (airport){   
