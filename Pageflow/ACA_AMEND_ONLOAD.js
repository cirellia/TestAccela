...
//execute
//var theAInfo = new Array();
//loadAppSpecific4ACA(theAInfo);

//var capModelInited = aa.env.getValue("CAP_MODEL_INITED");
//try{
//    if (capModelInited != "TRUE") {
    //if(theAInfo["Changes"] == "Yes" || theAInfo["Changes"] == "Y") {
          //copy();
        //showMessage=true; showDebug=3;
    //}
//    } 
//}
//catch(err){
...
function copy() {
 ...
 capModel = aa.env.getValue("CapModel");
    ...
    copyAppSpecific4ACA(parentCapId);
        ...
        copyAppName(parentCapId, capModel);
...
parentCap =aa.cap.getCapViewBySingle4ACA(capFrom);  
var i= parentCap.getAppSpecificInfoGroups().iterator();
...
function editAppSpecific(itemName, itemValue)  // optional: itemCap
{
 ...
 function editAppSpecific4ACA(itemName, itemValue) {
    ...
    //targetCap = aa.cap.getCapViewBySingle4ACA(targetCapId); 
